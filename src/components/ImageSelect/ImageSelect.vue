<template>
    <div class="select">
        ...
        <ImageDropdown v-if="open" :items="items" :onSelect="onSelect" :onClose="onClose" />
    </div>
</template>
...
const { placeholder, items, value, onSelect } = defineProps(["placeholder", "items", "value", "onSelect"])
